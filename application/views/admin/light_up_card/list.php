            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                if (!empty($records)) : foreach ($records as $record) : ?>
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><img src="<?php echo !empty($record->picture) ?  base_url('assets/front/img/') . $record->picture : ''; ?>" alt="" class="admin_imgs"></td>
                      <td><?php echo !empty($record->content) ? $record->content : ''; ?></td>
                      <td>
