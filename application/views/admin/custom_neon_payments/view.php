        ...
        <div class="box box-primary">
          ...
          <div class="col-md-12">
              <div class="box-body box-body-view">
                ...
                $db = $record->custom_neon_payments_created_at;
                ...
                <?php if(!empty($record->sizeTitle)):?>
                  <div class="form-group clearfix">
                      <span class="col-md-2 view_label">Size</span>
                      <span class="col-md-10 view_details"><?php echo $record->sizeTitle;?></span>
                  </div>  
                <?php endif;?>

                <?php if(!empty($record->sizePrice)):?>
                  <div class="form-group clearfix">
                      <span class="col-md-2 view_label">Size Price</span>
                      <span class="col-md-10 view_details"><?php echo $record->sizePrice;?></span>
                  </div>  
                <?php endif;?>
