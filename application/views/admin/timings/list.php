            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                if (!empty($records)) : foreach ($records as $record) : ?>
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><?php echo !empty($record->day_start) ? $record->day_start . " to " . $record->day_end : ''; ?></td>
                      <td><?php echo !empty($record->full_day) ? $record->full_day . " - " . $record->full_day2 : ''; ?></td>
                      <?php


                      ?>
                      <td><?php if ($record->open_close == 'close') {
                            echo 'Closed';
                          } else {
                            echo !empty($record->first_half) ? $record->first_half . " - " . $record->first_half2 : '';
                          } ?></td>
                      <!-- <td><?php echo !empty($record->second_half) ? $record->second_half . " - " . $record->second_half2 : ''; ?></td> -->
                      <td>
