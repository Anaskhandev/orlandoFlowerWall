            ...
            <form role="form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Content of card</label><br>
                  <textarea type="name" class="form-control editor" id="content" name="content" required value="<?php echo !empty($r->main_heading) ? $r->main_heading : '' ?>"></textarea>
