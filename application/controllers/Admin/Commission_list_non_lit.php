...
class Commission_list_non_lit extends Admin_Controller {
    ...
    public function index(){
      ...
      ->where(array('non_lit_custom_neon_payments_status' => 'enable', 'commissionStatus' => 'Not Paid'))
      ->group_by('payment_id')->order_by('non_lit_custom_neon_payments_id', 'desc')->get()->result();
