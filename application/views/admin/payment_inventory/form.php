          ...
          <div class="col-md-6">
            <form role="form" action="<?php echo $action;?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Length</label>
                  <input type="name" class="form-control" id="length" name="length" required value="<?php echo !empty($record->length)?$record->length:''?>">
                ...
                <div class="form-group">
                  <label>Rebo Commission</label>
                  <input type="name" class="form-control" id="second_commission" name="second_commission" required value="<?php echo !empty($record->second_commission)?$record->second_commission:''?>">
