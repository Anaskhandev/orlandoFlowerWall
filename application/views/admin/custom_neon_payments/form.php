            ...
            <form role="form" action="<?php echo $action;?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Commission Paid?</label><br>
                  <span>Paid or Not Paid (only)</span><br>
                  <input type="name" class="form-control" id="commissionStatus" name="commissionStatus" required value="<?php echo !empty($record->commissionStatus)?$record->commissionStatus:''?>">
                  <?php echo form_error('commissionStatus'); ?>
                </div>          
