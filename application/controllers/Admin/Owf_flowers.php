...
class Owf_flowers extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $content['records']  = $this->db->select('*')->from('owf_flowers')
            ->where(array('owf_flowers_status' => 'enable'))->order_by('owf_flowers_id', 'desc')->get()->result();
    ...
    public function view($id)
    {
        if ($this->is_crud == true) {
            $content['record']  = $this->db->select('*')->from('owf_flowers')
                ->where(array('owf_flowers_id' => $id))->get()->result();
