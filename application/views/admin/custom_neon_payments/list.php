          ...
          <div class="box-body">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>            
                ...
                <tr>
                  <td><?php echo $i;?></td>
                  <td><?php echo !empty($record->fullName)?$record->fullName:'';?></td>
                  <td><?php echo !empty($record->textTitle)?$record->textTitle:'';?></td>
                  <td><?php echo !empty($record->totalPrice)?$record->totalPrice:'';?></td>
                  <td><?php echo !empty($record->sizeTitle)?$record->sizeTitle:'';?></td>
                  <td><?php echo !empty($record->sizePrice)?$record->sizePrice:'';?></td>
                  ...
                  <td><?php echo !empty($record->commissionStatus)?$record->commissionStatus:'';?></td>
