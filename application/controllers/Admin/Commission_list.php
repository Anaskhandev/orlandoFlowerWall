...
class Commission_list extends Admin_Controller {
    ...
    public function index(){
      ...
      $content['records']  = $this->db->select('*')->from('custom_neon_payments')
      ->join('manage_prices', 'manage_prices.size = custom_neon_payments.sizeTitle')
      ->where(array('custom_neon_payments_status' => 'enable', 'commissionStatus' => 'Not Paid'))
      ->group_by('payment_id')->order_by('custom_neon_payments_id', 'desc')->get()->result();
