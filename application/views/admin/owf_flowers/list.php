              ...
              <tbody>
                ...
                if (!empty($records)) : foreach ($records as $record) : ?>
                    <tr>
                      ...
                      <td><?php echo !empty($record->email) ? $record->delivery_type : ''; ?></td>
                      <td><?php echo !empty($record->totalPrice) ? $record->totalPrice : ''; ?></td>
                      <td><?php echo !empty($record->address) ? $record->address : ''; ?></td>
                      <td><?php echo !empty($record->order_text) ? $record->order_text : ''; ?></td>
                      <td><?php echo !empty($record->items) ? $record->items : ''; ?></td>
                      <td>
