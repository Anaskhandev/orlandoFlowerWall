            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                if (!empty($records)) : foreach ($records as $record) : ?>
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><img src="<?php echo base_url('/assets/front/img/upload/') . $record->picture; ?>" class="admin_imgs" /></td>
                      <td><?php echo !empty($record->name) ? $record->name : ''; ?></td>
                      <td>$<?php echo !empty($record->price) ? $record->price : ''; ?></td>
                      <td><?php echo !empty($record->related) ? $record->related : ''; ?></td>
                      <td>
