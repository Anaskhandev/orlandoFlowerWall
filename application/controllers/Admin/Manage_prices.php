    ...
    public function form($form_type = "", $id = "")
    {
        ...
        if ($_POST) {
            ...
            if (!$this->form_validation->run() == FALSE) {
                ...
                // echo $content['Processing_Fee'];
                $total_p = $content['total_price'];
                $Processing_Fee = $total_p * 0.04;
                // echo $Processing_Fee;
                $content['Processing_Fee'] = $Processing_Fee;
