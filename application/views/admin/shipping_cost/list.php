            ...
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                if (!empty($records)) : foreach ($records as $record) : ?>
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><?php echo !empty($record->Height) ? $record->Height." inches" : ''; ?></td>
                      <td><?php echo !empty($record->Width) ? $record->Width : ''; ?></td>
                      <td>$ <?php echo !empty($record->cost) ? $record->cost : ''; ?></td>
