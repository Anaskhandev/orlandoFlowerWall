              ...
              <tbody>
                ...
                if (!empty($records)) : foreach ($records as $record) : ?>
                    <tr>
                      ...
                      <td>
                        <?php echo !empty($record->home) && $record->home == 1 ? '<li>Home</li>' : ''; ?>
                        <?php echo !empty($record->gifts) && $record->gifts == 1 ? '<li>Gifts</li>' : ''; ?>
                        <?php echo !empty($record->flowers) && $record->flowers == 1 ? '<li>Flowers</li>' : ''; ?>
                      </td>
                      <td><?php echo !empty($record->text) ? $record->text : ''; ?></td>
                      <td><?php echo !empty($record->relatedContent) ? $record->relatedContent : ''; ?></td>
                      <td>
